			...
			<div class="container-content">
				...
				<div class="taxonomy-content">
					...
					<form action="" class="sort">
                        ...
                        <div>
                            <input type="checkbox" name="mounth-12" id="mounth-12">
                            <label for="mounth-12">На 12 месяцев</label>
                            <input type="checkbox" name="mounth-6" id="mounth-6">
                            <label for="mounth-6">На 6 месяцев</label>
                            <input type="checkbox" name="mounth-3" id="mounth-3">
                            <label for="mounth-3">На 3 месяца</label>
                        </div>
					</form>
					<span class="hr"></span>
